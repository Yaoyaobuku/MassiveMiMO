clear; M=40; K=20; nbrOfRealizations = 1; D_sqr = 1000;
tau_cf = 10; taud_sc = 20; tauu_sc = 20; BW = 20e6; NF_dB = 9;
...
Rate_CF = zeros(K,Nstep,NumMonteCarlo);
Rate_SC = zeros(K,Nstep,NumMonteCarlo);
